...
<h2>User</h2>
		<p>Formulaire d'ajout ou de modification de user:</p>

<form:form action="ajouterUser" modelAttribute="uUser" method="POST" class="form-horizontal" >
  ...
  <div class="form-group">
    <label for="inputUserName" class="col-sm-2 control-label">Nom du user</label>
    <div class="col-sm-8">
