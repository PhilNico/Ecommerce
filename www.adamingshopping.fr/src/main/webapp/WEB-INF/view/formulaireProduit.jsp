...
<body>
	...
	<form:form action="ajouterProduit" modelAttribute="pProduit"
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<form:input type="text" class="form-control" id="inputDesignation"
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<form:input type="text" class="form-control" id="inputPrix"
		...
		<div class="form-group">
			<label for="inputCat" class="col-sm-2 control-label">Categorie</label>
			<div class="col-sm-8">
				<form:input type="text" class="form-control" id="inputCat"
					placeholder="Categorie" path="categorie.idCategorie" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="file" name="file" class="form-control" id="inputPhoto" />
			</div>
		</div>
